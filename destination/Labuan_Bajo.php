...
<head>
    ...
    <title>Labuan bajo - Enjoy travel</title>
...
<body>
    <div id="app" class="hidden">
        ...
        <div class="h-screen w-screen">
            <img src="../images/bag labuan bajo.jpg" class="w-full h-full">
        </div>

        <div class="container mx-auto px-14 h-screen py-20 flex">
            <div class="w-1/2 pr-4 flex flex-col self-center">
                <div class="flex">
                    <h1 class="text-3xl mb-3 border-b-2 border-indigo-500">Labuan Bajo</h1>
                </div>
                <p>Labuan Bajo berlokasi di Flores, Nusa Tenggara Timur, merupakan tempat yang di rekomendasikan karena menjadi wisata premium berkat keindahan pantai dan makhluk purbakala yang hidup di sana, yaitu Komodo. Labuan Bajo semakin dikenal masyarakat Indonesia, dengan beragam trip yang menawarkan perjalanan menyusuri dan berkeliling pulau dan pantai. Salah satu yang di kenal kalangan wisatawan adalah Pulau Komodo dan pantai pasir pink. Namun terdapat banyak lagi yang dapat dikunjungi saat berlibur di Kabupaten Manggarai Barat, Flores, NTT, di antaranya: Pulau Rinca, Gili Laba, Pulau Kanawa, Pulau Padar, dll.</p>
                <div class="flex">
                    <a href="https://google.com/search?q=labuan+bajo" class="py-3 px-7 outline-none rounded-full mt-8 bg-transparent border-2 border-indigo-500 text-indigo-500 focus:outline-none focus:bg-indigo-500 focus:text-white focus:ring ring-indigo-400" target="_blank">More detail on google</a>
                </div>
            </div>
            <div class="w-1/2 flex self-center">
                <img src="../images/Labuan Bajo.jpeg" class="w-full rounded-md">
            </div>
        </div>
    </div>
